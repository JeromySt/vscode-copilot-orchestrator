...
> **References**: Verify changes against `test-writer.instructions.md` (test patterns), `di-refactor.instructions.md` (DI rules), `security-hardener.instructions.md` (security checks), and `software-architect.instructions.md` (architecture patterns & diagrams).
