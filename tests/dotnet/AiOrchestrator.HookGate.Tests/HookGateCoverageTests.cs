...
public sealed class HookGateCoverageTests
{
    ...
    public void HookApprovalDeniedException_ExposesReasonAndKind()
    {
        ...
        _ = ex.Reason.Should().Be("nope");
        _ = ex.Kind.Should().Be(HookKind.PrePush);
        _ = ex.Message.Should().Contain("nope").And.Contain("PrePush");
    }
    ...
    public void HookGateOptions_HasSensibleDefaults()
    {
        ...
        _ = o.NonceRotation.Should().Be(TimeSpan.FromMinutes(5));
        _ = o.ApprovalTokenTtl.Should().Be(TimeSpan.FromMinutes(2));
        _ = o.RequireImmutability.Should().BeFalse();
        _ = o.PipeName.Should().NotBeNullOrEmpty();
        _ = o.SocketPath.Value.Should().NotBeNullOrEmpty();
    }
    ...
    public void NonceManager_ForceRotate_RaisesRotatedEvent()
    {
        ...
        _ = observed!.Previous.Should().NotBeNull();
        _ = observed.Current.Should().NotBeNull();
        _ = observed.Previous!.Value.Should().Be(before.Value);
    }
    ...
    public void NonceManager_Constructor_RejectsNullDependencies()
    {
        ...
        _ = a.Should().Throw<ArgumentNullException>();
        _ = b.Should().Throw<ArgumentNullException>();
    }
    ...
    public void ApprovalIssuer_FormatTimestamp_ProducesRoundtrippableIso()
    {
        ...
        _ = DateTimeOffset.Parse(s, System.Globalization.CultureInfo.InvariantCulture).Should().Be(t);
    }
    ...
    public void ApprovalIssuer_NewTokenId_ProducesDistinctHex()
    {
        ...
        _ = t1.Should().NotBe(t2);
        _ = t1.Length.Should().Be(32);
    }
    ...
    public void ApprovalIssuer_Issue_ProducesExpiryEqualToNowPlusTtl()
    {
        ...
        _ = approval.ExpiresAt.Should().Be(now + TimeSpan.FromMinutes(2));
        _ = approval.IssuedAt.Should().Be(now);
        _ = approval.Hmac.Should().NotBeEmpty();
    }
    ...
    public async Task HookGateClient_WrapsDaemon_And_DelegatesCheckIn()
    {
        ...
        _ = approval.TokenId.Should().NotBeNullOrEmpty();
        _ = audit.Records.Should().Contain(r => r.EventType == "hook.approve");
    ...
    public async Task EventBusImmutabilityEventSink_ForwardsPublish()
    {
        ...
        _ = bus.Published.Should().ContainSingle().Which.Should().BeSameAs(evt);
    }
    ...
    public async Task ToolRunner_CollectsStdout_OnSuccess()
    {
        ...
        _ = code.Should().Be(0);
        _ = stdout.Should().Be("hello-world");
    }
    ...
    public async Task LinkValidator_RejectsNonExistentHook()
    {
        ...
        _ = r.Ok.Should().BeFalse();
        _ = r.FailureReason.Should().NotBeNullOrEmpty();
    }
    ...
    public async Task WindowsRedirectionManager_GetActiveMode_ReturnsNotInstalledForMissingPath()
    {
        ...
        _ = mode.Should().Be(RedirectionMode.NotInstalled);
    }
    ...
    public void WindowsRedirectionManager_Constructor_RejectsNulls()
    {
        ...
        _ = a.Should().Throw<ArgumentNullException>();
        _ = b.Should().Throw<ArgumentNullException>();
        _ = c.Should().Throw<ArgumentNullException>();
    }
    ...
    public async Task UnixSocketRpcServer_RejectsStart_OnWindows()
    {
        ...
        _ = await act.Should().ThrowAsync<PlatformNotSupportedException>();
        await s.DisposeAsync();
    }
    ...
    public async Task ImmutabilityProbe_WindowsBranch_ClassifiesExitCode()
    {
        ...
        _ = r.Supported.Should().BeTrue();
        _ = r.Mechanism.Should().Be("DACL-deny");
    }
    ...
    public void HookGateDaemon_Constructor_RejectsEveryNull()
    {
        ...
        _ = ((Action)(() => _ = new HookGateDaemon(null!, rpc, redirect, clock, bus, opts, log, audit))).Should().Throw<ArgumentNullException>();
        _ = ((Action)(() => _ = new HookGateDaemon(nonces, null!, redirect, clock, bus, opts, log, audit))).Should().Throw<ArgumentNullException>();
        _ = ((Action)(() => _ = new HookGateDaemon(nonces, rpc, null!, clock, bus, opts, log, audit))).Should().Throw<ArgumentNullException>();
        _ = ((Action)(() => _ = new HookGateDaemon(nonces, rpc, redirect, null!, bus, opts, log, audit))).Should().Throw<ArgumentNullException>();
        _ = ((Action)(() => _ = new HookGateDaemon(nonces, rpc, redirect, clock, null!, opts, log, audit))).Should().Throw<ArgumentNullException>();
        _ = ((Action)(() => _ = new HookGateDaemon(nonces, rpc, redirect, clock, bus, null!, log, audit))).Should().Throw<ArgumentNullException>();
        _ = ((Action)(() => _ = new HookGateDaemon(nonces, rpc, redirect, clock, bus, opts, null!, audit))).Should().Throw<ArgumentNullException>();
        _ = ((Action)(() => _ = new HookGateDaemon(nonces, rpc, redirect, clock, bus, opts, log, null!))).Should().Throw<ArgumentNullException>();
    }
    ...
    public async Task HookGateDaemon_DeniesCheckIn_WhenShutDown()
    {
        ...
        Func<Task> act = async () => await d.HandleCheckInAsync(req, CancellationToken.None);
        _ = await act.Should().ThrowAsync<HookApprovalDeniedException>();
        _ = audit.Records.Should().Contain(r => r.EventType == "hook.deny" && r.ContentJson!.Contains("shutting down"));
        await d.DisposeAsync();
    }
    ...
    public async Task NamedPipeRpcServer_AcceptsConnection_AndIncrementsPeerChecks()
    {
        ...
        _ = s.PeerCredChecksPerformed.Should().BeGreaterThanOrEqualTo(1);
    ...
    public async Task WindowsRedirectionManager_FallsBackToSymlink_WhenJunctionFails()
    {
        ...
        try
        {
            ...
            _ = events.Events.Should().ContainSingle().Which.Mechanism.Should().Be("symlink");
        }
        catch (IOException)
        {
