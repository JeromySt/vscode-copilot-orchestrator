...
public class MyClass
{
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0001);
    }
...
public class MyClass
{
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0001Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0001);
    }
}
...
namespace AiOrchestrator.OtherService
{
    ...
    public class Consumer
    {
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0002);
    }
...
namespace AiOrchestrator.Composition
{
    ...
    public class CompositionRoot
    {
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0002Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0002);
    }
}
...
namespace AiOrchestrator.Core
{
    ...
    public class Foo { }
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0003);
    }
...
namespace AiOrchestrator.Core
{
    ...
    public class Foo { }
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0003Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0003);
    }
}
...
namespace AiOrchestrator.Core
{
    public class Worker
    {
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0004);
    }
...
namespace AiOrchestrator.Core
{
    public class Worker { public void Run() { } }
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0004Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0004);
    }
}
...
namespace AiOrchestrator.Core
{
    public class Worker
    {
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0005);
    }
...
namespace AiOrchestrator.Core
{
    public class Worker { public void Run() { } }
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0005Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0005);
    }
}
...
namespace AiOrchestrator.Core
{
    ...
    public class Worker { }
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0006);
    }
...
namespace AiOrchestrator.Core
{
    public class Worker { }
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0006Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0006);
    }
}
...
public class MyService
{
    public async Task DoWorkAsync() => await Task.CompletedTask;
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0007);
    }
...
public class MyService
{
    public async Task DoWorkAsync(CancellationToken ct) => await Task.CompletedTask;
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0007Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0007);
    }
}
...
public class MyClass
{
    public async void BadMethod() { await Task.CompletedTask; }
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0008);
    }
...
public class MyClass
{
    public async Task GoodMethod(CancellationToken ct) { await Task.CompletedTask; }
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0008Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0008);
    }
}
...
public partial class NativeMethods
{
    ...
    public static extern int GetMessage();
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0009);
    }
...
public class MyClass
{
    public void DoWork() { }
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0009Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0009);
    }
}
...
public class Worker
{
    public void Run() { var t = DateTime.UtcNow; }
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0010);
    }
...
public class Worker { public void Run() { } }";
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0010Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0010);
    }
}
...
public class Worker
{
    public void Run() { var s = File.ReadAllText(""x""); }
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0011);
    }
...
public class Worker { public void Run() { } }";
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0011Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0011);
    }
}
...
public class Worker
{
    public void Run() { Process.Start(""notepad""); }
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0012);
    }
...
public class Worker { public void Run() { } }";
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0012Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0012);
    }
}
...
public class Worker
{
    public void DoWork(dynamic value) { }
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0020);
    }
...
public class Worker
{
    public void DoWork(string value) { }
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0020Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0020);
    }
}
...
public sealed class MyTests
{
    ...
    public void SomeTest() { }
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0030);
    }
...
public sealed class MyTests
{
    ...
    public void SomeTest() { }
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0030Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0030);
    }
}
...
public class Worker
{
    public void Run()
    {
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0040);
    }
...
public class Worker { public void Run() { } }";
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0040Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0040);
    }
}
...
public class Worker
{
    ...
    public void Run(string name)
    {
        ...
        diags.Should().Contain(d => d.Id == DiagnosticIds.OE0046);
    }
...
public class Worker
{
    ...
    public void Run(string name)
    {
        ...
        var diags = await AnalyzerTestHelper.GetDiagnosticsAsync(source, new OE0046Analyzer());
        diags.Should().NotContain(d => d.Id == DiagnosticIds.OE0046);
    }
}
...
public sealed class AnalyzersPackAndDogfoodTests
{
    ...
    public void ANALYZERS_PACK_IsPackedAsAnalyzerOutput()
    {
        ...
        File.Exists(csproj).Should().BeTrue("Analyzer csproj must exist");
        var content = File.ReadAllText(csproj);
        content.Should().Contain("IsPackable>true", "Analyzer project must be packable");
        content.Should().Contain("IsAnalyzer>true", "Analyzer project must set IsAnalyzer=true");
        content.Should().Contain("analyzers/dotnet/cs", "DLL must be placed in analyzers/dotnet/cs/ in the NuGet package");
    }
    ...
    public void ANALYZERS_DOGFOOD_AppliesToOwnSource()
    {
        ...
        File.Exists(targets).Should().BeTrue("Directory.Build.targets must exist");
        var content = File.ReadAllText(targets);
        content.Should().Contain("AiOrchestrator.Analyzers.csproj",
            "Directory.Build.targets must reference AiOrchestrator.Analyzers");
        content.Should().Contain("OutputItemType=\"Analyzer\"",
            "Analyzer must be referenced with OutputItemType=Analyzer");
    }
}