...
suite('MCP Handler Unit Tests', () => {
  ...
  setup(() => {
    ...
    handler = new McpHandler(mockPlanRunner as any, workspacePath, {} as any, undefined, {} as any);
  });
  ...
  suite('Constructor', () => {
    test('should initialize with PlanRunner and workspace path', () => {
      const h = new McpHandler(mockPlanRunner as any, '/test/path', {} as any, undefined, {} as any);
      assert.ok(h);
    });
  });
