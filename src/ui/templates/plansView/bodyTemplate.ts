...
export function renderPlansViewBody(): string {
  return `<div class="sidebar-tabs">
    <button class="tab active" data-tab="plans" id="tabPlans">
      Plans
      <span class="tab-badge" id="tabBadgePlans" style="display: none;">0</span>
    </button>
    <button class="tab" data-tab="releases" id="tabReleases">
      Releases
      <span class="tab-badge" id="tabBadgeReleases" style="display: none;">0</span>
    </button>
    <button class="tab" data-tab="prs" id="tabPRs">
      PRs
      <span class="tab-badge" id="tabBadgePRs" style="display: none;">0</span>
    </button>
  </div>
